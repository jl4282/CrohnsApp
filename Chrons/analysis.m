...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
    ...
    if(section == 1)
		return @"Food that gives DIARREA";
    if (section == 2)
        return @"Food that cause BATHROOM URGENCY";
    if (section == 3)
        return @"Food that cause CONSTIPATION";
    if (section == 4)
...
/*-(void)viewDidLoad
 ...
 //chapters = [[NSArray alloc]initWithObjects:@"1",@"2",@"3", nil];
